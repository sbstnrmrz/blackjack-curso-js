(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const d of o.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&i(d)}).observe(document,{childList:!0,subtree:!0});function f(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(r){if(r.ep)return;r.ep=!0;const o=f(r);fetch(r.href,o)}})();function E(){const u=document.querySelector("#player-cards"),a=document.querySelector("#dealer-cards"),f=document.querySelector("#player-score"),i=document.querySelector("#dealer-score"),r=document.querySelector("#game-over-msg");let o=[];const d=document.querySelector("#hit-button"),q=document.querySelector("#new-game-button"),m=document.querySelector("#stand-button"),y="/cartas/",x={red:"/cartas/red_back.png"};let n={cards:[],score:0},c={cards:[],score:0},P=["C","S","H","D"],w={10:"J",11:"Q",12:"K"};for(const e of P)for(let t=0;t<13;t++){const s=t%13;let l="";s<10&&(l=`${t+1}${e}`),s==0&&(l=`A${e}`),s>9&&(l=`${w[t]}${e}`),o.push(l)}console.log(o.length);function h(){n.cards=[],u.textContent="",S(),c.cards=[],a.textContent="",L(),g(),O(),C(),d.disabled=!1,m.disabled=!1,r.textContent=""}function b(){for(d.disabled=!0,m.disabled=!0,document.querySelector("#hidden-card").remove(),g();c.score<17&&n.score<=21;)g();let e="";n.score==c.score?e="Draw":n.score>21||c.score>n.score&&c.score<=21?e="Player Lose":e="Player Wins",r.textContent=e}function v(){return o[Math.floor(Math.random()*o.length)]}function p(e){let t=0;const s=e.length==3?e.slice(0,2):e.slice(0,1);return parseInt(s)<=10?t=parseInt(s):s=="A"?t=11:t=10,t}function C(){const e=v(),t=document.createElement("img");t.src=y+e+".png",t.classList.add("card"),u.appendChild(t),n.cards.push(e),S(),n.score>21&&(console.log("tralalero tralalal"),b())}function g(){const e=v(),t=document.createElement("img");t.src=y+e+".png",t.classList.add("card"),a.appendChild(t),c.cards.push(e),L(),console.log("dealer hit card: "+e),console.log("dealer cards: "+c.cards),console.log("card score: "+p(e))}function O(){const e=document.createElement("img");e.src=x.red,e.id="hidden-card",e.classList.add("card"),a.appendChild(e)}function S(){let e=0;for(const t of n.cards){const s=t.substring(0,1)=="A"&&n.score>=11;e+=s?1:p(t)}f.textContent="Jugador - "+e,n.score=e,console.warn("current player score: "+n.score)}function L(){let e=0;for(const t of c.cards)e+=p(t);c.score=e,i.textContent="Dealer - "+e}m.addEventListener("click",()=>{b()}),d.addEventListener("click",()=>{C()}),q.addEventListener("click",()=>{h()}),h()}document.querySelector("#app").innerHTML=`
  <div>
    <div class='row my-2'>
